...
from train_model.config.xgb_config import XGB_PARAMS
...
from train_model.core.xgb_training import train_xgb
...
def main():
    ...
    save_model(model, os.path.join(MODEL_DIR, "xgb_model.joblib"))
